...
TEXT = [
    ...
    "𝐎𝚈𝙴 𝐂𝙷𝙰𝙼𝚃𝚄 𝐕𝙲 𝐀𝙰 𝐄𝙺 𝐄𝙰𝙼 𝐇𝘼𝙸🤨",
    "𝐒𝙄𝙉𝙊 𝐕𝙲 𝐉𝙾𝙸𝙉 𝐊𝚁 𝐋𝙾🤣",
    "𝐕𝙲 𝐀𝙰 𝐉𝙰𝙸𝚈𝙴 𝐄𝙺 𝐁𝙰𝚁😁",
    "𝐕𝙲 𝐓𝙰𝙿𝙺𝙾 𝐆𝙰𝙼𝙴 𝐂𝙷𝙰𝙻𝚄 𝐇𝘼𝙸⚽️",
    "𝐕𝙲 𝐀𝙰𝙾 𝐁𝙰𝚁𝙽𝙰 𝐁𝙰𝙽 𝐇𝙾 𝐉𝙰𝙾𝙶𝙴🥺",
    "𝐒𝙊𝙍𝙍𝙔 𝐕𝘼𝙱𝙔 𝐏𝙻𝚂 𝐕𝙲 𝐀𝙰 𝐉𝙰𝙾 𝐍𝙰😥",
    "𝐕𝙲 𝐀𝙰𝙽𝙰 𝐄𝙺 𝐂𝙷𝙸𝙹 𝐃𝙸𝙺𝙷𝙰𝚃𝙸 𝐇𝚄🙄",
    "𝐕𝙲 𝐌𝙴 𝐂𝙷𝙴𝙲𝙺 𝐊𝚁𝙺𝙴 𝐁𝙰𝚃𝙰𝙾 𝐓𝙾 𝐒𝙾𝙽𝙂 𝐏𝙻𝙰𝚈 𝐇𝙾 𝐑𝙷𝘼 𝐇?🤔",
    "𝐕𝙲 𝐉𝙾𝙸𝙽 𝐊𝚁𝙽𝙴 𝐌𝙴 𝐊𝚈𝘼 𝐉𝙰𝚃𝙰 𝐇 𝐓𝙷𝙾𝚁𝙰 𝐃𝙴𝚁 𝐊𝙰𝚁 𝐋𝙾 𝐍𝙰🙂",
    "OWNER KO AK BAR DM KRKE TXN BOLDO PLEASE🥺 @lll_notookk_lll",
]
...
async def mentionall(client, message):
    ...
    try:
        ...
        if participant and participant.status in ("administrator", "creator"):
            is_admin = True
    ...
    async for usr in client.iter_chat_members(chat_id):
        ...
        if usrnum == 1:
            if mode == "text_on_cmd":
                ...
                await msg.reply(f"{random.choice(TEXT)}")
...
async def cancel_spam(client, message):
    ...
    try:
        ...
        pass  # Handle the exception accordingly based on your requirements
    ...
    if not is_admin:
        ...
        try:
            ...
            pass
        return await message.reply("Tagging process has been canceled.")
