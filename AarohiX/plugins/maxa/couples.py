...
from AarohiX.mongo.couples_db import _get_image, get_couple
    ...
    try:
     ...
     #  if not is_selected:
         ...
         try:
            ...
            p1 = "AarohiX/assets/upic.png"
         try:
            p2 = await app.download_media(photo2.big_file_id, file_name="pfp1.png")
         except Exception:
            p2 = "AarohiX/assets/upic.png"
         ...
         img1 = img1.resize((490,490))
         img2 = img2.resize((490,490))
         ...
         img.paste(img1, (45, 110), img1)
         img.paste(img2, (750, 120), img2)
